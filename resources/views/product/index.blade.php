        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{date('d/m/Y',strtotime($product->datumLevering))}}</td>
                    <td>
                        <a href="{{route('productperleverancier.index', [$info->id, $product->id])}}"><img class="small-img" src="/img/plus.png" alt="plus.png"></a>
                    </td>
                    @else
                    <script>
                        setTimeout(function() {
